export default class Person{
    ...
    formatted(language){
        ...
        return {
            ...
            from: new Intl.DateTimeFormat(language, {month: 'long', year: 'numeric', day: '2-digit'}).format(mapDate(this.from)),
            to: new Intl.DateTimeFormat(language, {month: 'long', year: 'numeric', day: '2-digit'}).format(mapDate(this.to)),
        }
    }
